...
class EKE_ORM {
  ...
  private $query = null;
	 ...
	 */
	public function directQuery($query, $params = null) {

		return $this->query->dirty($this->db, $query, $params);
	...
	public function getResultNum() {
		...
		return $this->query->getResultNum();
	...
	public function getAffectedNum() {
		...
		return $this->query->getAffectedNum();
